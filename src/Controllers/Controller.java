...
private void RealizarPix() {
  ...
  if(confirmarsenhaPIX()) {
	    ...
	    double saldonovo_clienteatual =
	        cliente.getSaldo() - Double.parseDouble(field_valorpix.getText());

	    double saldonovo_clientedestino =
	        cliente_pix.getSaldo() + Double.parseDouble(field_valorpix.getText());
